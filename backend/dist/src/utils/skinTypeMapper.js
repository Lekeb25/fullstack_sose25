...
exports.mapSkinType = mapSkinType;
exports.SkinAdviceforSkinAnalyse = SkinAdviceforSkinAnalyse;
function mapSkinType(faceApiValue) {
    const mapping = ['fettig', 'trocken', 'normal', 'misch'];
    return mapping[faceApiValue] || 'normal';
}
function SkinAdviceforSkinAnalyse(skinType) {
    const advices = {
        fettig: `
